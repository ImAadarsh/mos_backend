			...
			<tr>
				<td>
					<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
						role="presentation"
						style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FDB11C;" width="100%">
						<tbody>
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										class="row-content stack" role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FDB11C; color: #000000; width: 640px; margin: 0 auto;"
										width="640">
										<tbody>
											<tr>
																	...
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tr>
																			<td class="divider_inner"
																				style="font-size: 1px; line-height: 1px; border-top: 4px solid #FDB11C;">
																				<span> </span></td>
																		</tr>
																	</table>
																</div>
																...
																<div align="center" class="alignment"
																	...
																	<div class="fullWidth" style="max-width: 352px;">
																		<img alt="I'm an image" height="auto"
																			src="https://email.magicofskills.com/images/Img5_2x.jpg"
																			style="display: block; height: auto; border: 0; width: 100%;"
															...
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0; word-break: break-word;"><span
																			style="color:#2b303a;"><strong>Thank you for
																				the payment</strong></span></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0; word-break: break-word;"><span
																			style="color:#808389;">Your Transaction is sucessfully completed with the Magic of Skills. Please Login to your magic of skills account to see all the details regarding your workshops. In Dashboard Section you can find all the actions for your purchased workshop.</span></p>
																</div>
															</td>
														</tr>
													</table>
								...
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content"
										...
										<tbody>
											<tr>
												<td class="column column-1"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; background-color: #f3fafa; border-left: 20px solid #FFF; border-right: 8px solid #FFF; vertical-align: top; border-top: 0px; border-bottom: 0px;"
													width="50%">
													<table border="0" cellpadding="0" cellspacing="0"
														class="divider_block block-1" role="presentation"
														style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-left:5px;padding-right:5px;padding-top:35px;">
																<div
																	...
																	<p style="margin: 0; word-break: break-word;"><span
																			style="color: #a2a9ad;"><strong>TRANSACTION ID</strong></span></p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-bottom:40px;padding-left:5px;padding-right:5px;">
																<div
												...
												<td class="column column-2"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; background-color: #f3fafa; border-left: 8px solid #FFF; border-right: 20px solid #FFF; vertical-align: top; border-top: 0px; border-bottom: 0px;"
													width="50%">
													<table border="0" cellpadding="0" cellspacing="0"
														class="divider_block block-1" role="presentation"
														style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
														...
														<tr>
															<td class="pad"
																...
																<div
																	style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:12px;line-height:150%;text-align:center;mso-line-height-alt:18px;">
																	<p style="margin: 0; word-break: break-word;"><span
																			style="color:#a2a9ad;"><strong>TOTAL AMOUNT PAID</strong></span>
																	</p>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td class="pad"
																...
																<div
																	style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:20px;line-height:150%;text-align:center;mso-line-height-alt:30px;">
																	<p style="margin: 0; word-break: break-word;"><span
																			style="color: #2b303a;"><strong>Rs. {{$amount}}</strong></span>
																	</p>
																</div>
															</td>
														</tr>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:62px;width:210px;v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#FDB11C">
<w:anchorlock/>
															...
															<td class="pad" style="width:100%;">
																<div align="center" class="alignment"
																	...
																	<div style="max-width: 640px;"><img
																			alt="I'm an image" height="auto"
																			src="https://email.magicofskills.com/images/footer.png"
																			style="display: block; height: auto; border: 0; width: 100%;"
																		...
																		<tr>
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img alt="Facebook"
																						height="auto"
																						src="https://email.magicofskills.com/images/facebook2x.png"
																			...
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img alt="Twitter"
																						height="auto"
																						src="https://email.magicofskills.com/images/twitter2x.png"
																						style="display: block; height: auto; border: 0;"
																						title="Twitter"
																						width="32" /></a></td>
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img alt="Instagram"
																						height="auto"
																						src="https://email.magicofskills.com/images/instagram2x.png"
																						style="display: block; height: auto; border: 0;"
																						title="Instagram"
																						width="32" /></a></td>
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img alt="LinkedIn"
																						height="auto"
																						src="https://email.magicofskills.com/images/linkedin2x.png"
																						style="display: block; height: auto; border: 0;"
																						title="LinkedIn"
																						width="32" /></a></td>
																		</tr>
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0; word-break: break-word;"><span
																			style="color:#95979c;">At Magic of Skills, we believe that every student possesses unique talents and potential waiting to be discovered. Our mission is to provide a dynamic and engaging platform where students can learn new skills, explore their interests, and pave the way for a brighter future.</span></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0; word-break: break-word;"><span
																			style="color:#95979c;">Magic Of Skills Copyright ©
																			2024</span></p>
																</div>
															</td>
														</tr>
